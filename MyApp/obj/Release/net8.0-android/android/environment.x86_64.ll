...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1356947736317234560, ; hash 0x12d4d8c6d9f58d80, from name: aot-MyApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 32
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5543622787684901420, ; hash 0x4ceee78dd4b8222c, from name: libaot-MyApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 131
	...
	%struct.DSOCacheEntry {
		i64 6453975597606117178, ; hash 0x5991209c845a1f3a, from name: libaot-MyApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 146
	...
	%struct.DSOCacheEntry {
		i64 12575120580580699891, ; hash 0xae83cd8acd376ef3, from name: MyApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 321
	...
	%struct.DSOCacheEntry {
		i64 15625661950932825052, ; hash 0xd8d980c18db033dc, from name: MyApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 409
	...
	%struct.DSOCacheEntry {
		i64 17290709079094728270, ; hash 0xeff4f04c1e10164e, from name: aot-MyApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 448
...
@.env.3 = private unnamed_addr constant [37 x i8] c"3665b1b4-f486-49a2-92bc-f64306074674\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [22 x i8] c"com.companyname.myapp\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [20 x i8] c"libaot-MyApp.dll.so\00", align 16
